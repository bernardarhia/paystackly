export interface BasePaystackResponse {
  ...
  export interface BulkChargeListsReponse extends BasePaystackResponse, PaginationMetadata{
  ...
  export interface RefundResponse extends BasePaystackResponse {
    data: {
      transaction: {
        id: number;
        domain: string;
  ...
  export interface ListRefundResponse extends BasePaystackResponse {
  ...
  export interface FetchReFundReponse extends BasePaystackResponse {
    data: {
      integration: number;
      transaction: number;
      dispute: number | null;
